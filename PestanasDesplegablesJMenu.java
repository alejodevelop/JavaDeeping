...
public class PestanasDesplegablesJMenu extends JFrame implements ActionListener{ 
  private JMenuBar menubar;
  private JMenu menu1, menu2, menu3;
  private JMenuItem menuitem1, menuitem2, menuitem3, menuitem4;
 
  public PestanasDesplegablesJMenu(){
    setLayout(null);
  ...
  public static void main(String args []){
   PestanasDesplegablesJMenu interfaz = new PestanasDesplegablesJMenu();
