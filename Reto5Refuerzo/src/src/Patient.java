...
public class Patient extends Person {
    ...
    public static Patient getPatient(String id) {
        ...
        try {
            ...
            stmt.setString(1,); // Aqui debe enviar como parametro el id
    ...
    public static ArrayList<Patient> getAllPatients() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery(); // Aqui debe enviar como parametro el query
            while (rs.next()) {
    ...
    public static void deletePacient(String id) {
        ...
        try {
            PreparedStatement stmt = conn.prepareStatement(); // Aqui debe enviar como parametro el query
            stmt.setString(1,); // Aqui debe enviar como parametro el id
            stmt.executeUpdate();
            conn.close();
        } catch (SQLException e) {
    ...
    public static void savePatient(String name, String id, int age, String city, String composition, String echogenicity, String form, String margin, boolean echogenicFoci1, boolean echogenicFoci2, boolean echogenicFoci3, boolean echogenicFoci4, float size) {
        ...
        try {
            PreparedStatement stmt = conn.prepareStatement(query);
            stmt.setString(1,); // Aqui debe enviar como parametro el nombre
            stmt.setString(2,); // Aqui debe enviar como parametro el id
            stmt.setInt(3, age);
            stmt.setString(4,); // Aqui debe enviar como parametro la ciudad
            stmt.setString(5, composition);
            stmt.setString(6, echogenicity);
            stmt.setString(7, form);
            stmt.setString(8,); // Aqui debe enviar como parametro el margen
            ...
            Patient px = new Patient(); // Aqui debe instanciar un paciente
            stmt.setString(14, px.getAlert());
            stmt.setString(15,); // Aqui debe obtener el tratamiento del paciente con el metodo getTreatment de la instancia del paciente
    ...
    public static void editPatient(String searchID, String name, String id, int age, String city, String composition, String echogenicity, String form, String margin, boolean echogenicFoci1, boolean echogenicFoci2, boolean echogenicFoci3, boolean echogenicFoci4, float size) {
        ...
        try {
            ...
            stmt.setString(1,); // Aqui debe enviar como parametro el nombre
            stmt.setString(2,); // Aqui debe enviar como parametro el id
            stmt.setInt(3,); // Aqui debe enviar como parametro la edad
            stmt.setString(4,); // Aqui debe enviar como parametro la ciudad
            stmt.setString(5,); // Aqui debe enviar como parametro la composicion
            stmt.setString(6,); // Aqui debe enviar como parametro la ecogenicidad
            stmt.setString(7,); // Aqui debe enviar como parametro la forma
            stmt.setString(8,); // Aqui debe enviar como parametro el margen
            stmt.setBoolean(9,); // Aqui debe enviar como parametro el foco ecogenico 1
            stmt.setBoolean(10,); // Aqui debe enviar como parametro el foco ecogenico 2
            stmt.setBoolean(11,); // Aqui debe enviar como parametro el foco ecogenico 3
            stmt.setBoolean(12,); // Aqui debe enviar como parametro el foco ecogenico 4
            stmt.setFloat(13,); // Aqui debe enviar como parametro el tamaño
            Patient px = new Patient(); // Aqui debe instanciar un paciente
            stmt.setString(14,); // Aqui debe enviar como parametro la alerta del paciente con el metodo getAlert de la intancia
            stmt.setString(15,); // Aqui debe enviar como parametro el tratamiento del paciente con el metodo getTreatment de la instancia
